            ...
            <Card.Header >
                ...
                <div class="text-xl lg:flex">
                    {#if clarifications.status}
                        <div class="divhover:cursor-pointer hover:bg-slate-400 hover:dark:bg-gray-900 hover:cursor-pointer" on:click={(e) => goto(`/contests/${data.contest_id}/organizer/clarifications/${clarifications.id}`)}>{clarifications.title}&nbsp;</div>
                    {:else}
                        <div class="divhover:cursor-pointer text-gray-500 hover:bg-slate-400 hover:dark:bg-gray-900 hover:cursor-pointer" on:click={(e) => goto(`/contests/${data.contest_id}/organizer/clarifications/${clarifications.id}`)}>{clarifications.title}&nbsp;</div>
                    {/if}
